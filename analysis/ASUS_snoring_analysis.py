...
def main():
    ...
    for amplitude_factor in amplitude_factors:
        for first_erosion in first_erosions:
            save_path = rf'C:\Users\test\Desktop\Leon\Datasets\ASUS_snoring_subset\raw_final_test\freq2\{amplitude_factor}_{first_erosion}\raw_f_mono_16k'
...
def get_clip_from_frquency_thresholding(
    ...
    for d in dir_list:
        ...
        save_dir_list = utils.get_dir_list(save_path)
